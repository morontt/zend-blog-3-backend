 ...
 */
final class Version20230617074543 extends AbstractMigration implements ContainerAwareInterface
{
    /**
    ...
    public function postUp(Schema $schema)
    {
        ...
        $sql = file_get_contents(__DIR__ . '/sql/tracking_to_archive_03.sql');
