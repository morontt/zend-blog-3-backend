...
class Version20161113144623 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE geo_location (id INT AUTO_INCREMENT NOT NULL, city_id INT NOT NULL, ip_addr VARCHAR(15) NOT NULL, UNIQUE INDEX UNIQ_B027FE6A41FDCEBA (ip_addr), INDEX IDX_B027FE6A8BAC62AF (city_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE geo_location_city (id INT AUTO_INCREMENT NOT NULL, country_id INT NOT NULL, city VARCHAR(128) NOT NULL, region VARCHAR(128) NOT NULL, latitude DOUBLE PRECISION NOT NULL, longitude DOUBLE PRECISION NOT NULL, zip VARCHAR(30) NOT NULL, time_zone VARCHAR(8) NOT NULL, INDEX IDX_1C82828AF92F3E70 (country_id), UNIQUE INDEX UNIQ_1C82828A2D5B0234F62F176 (city, region), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE geo_location_country (id INT AUTO_INCREMENT NOT NULL, country_code VARCHAR(2) NOT NULL, country_name VARCHAR(64) NOT NULL, UNIQUE INDEX UNIQ_583FE876F026BB7C (country_code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
